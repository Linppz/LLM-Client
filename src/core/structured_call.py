...
class StructuredCall():
    ...
    def __init__(self, llm_client: BaseLLM, prompt_registry: PromptRegistry, output_parser: OutputParser, output_strategy : OutputStrategy  = OutputStrategy.JSON_MODE):
    ...
    async def call(self, prompts : dict, user_template : str,  output_schema, max_retries : int =3):
        ...
        if self.output_strategy == OutputStrategy.NATIVE:
            config.response_format = {"type": "json_schema", "json_schema": output_schema.model_json_schema()}
